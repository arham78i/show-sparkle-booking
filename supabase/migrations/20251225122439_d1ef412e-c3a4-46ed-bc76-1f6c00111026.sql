-- Drop and recreate function with fixed return type
DROP FUNCTION IF EXISTS public.complete_app_booking(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, DATE, TIME, JSONB, NUMERIC);

CREATE FUNCTION public.complete_app_booking(
  _tmdb_movie_id TEXT,
  _movie_title TEXT,
